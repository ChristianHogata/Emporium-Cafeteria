object frm_consulta_produto: Tfrm_consulta_produto
  ...
  object pnlCadastroProdutos: TPanel
    ...
    object pnlInformacoesCadastro: TPanel
      ...
      object GroupBoxPrecosCustos: TGroupBox
        Left = 16
        Top = 175
        Width = 593
        Height = 177
        ...
        object lbUnidadeEntrada: TLabel
          Left = 297
          Top = 28
          Width = 128
          Height = 23
          Caption = 'Unidade Entrada'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -17
          Font.Name = 'Segoe UI'
        ...
        object lbUnidadeSaida: TLabel
          Left = 453
          Top = 28
          Width = 110
          Height = 23
          Caption = 'Unidade Sa'#237'da'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -17
          Font.Name = 'Segoe UI'
        ...
        object edtUnidadeEntrada: TDBEdit
          Left = 453
          Top = 57
          Width = 110
          Height = 28
        ...
        object edtUnidadeSaida: TDBEdit
          Left = 303
          Top = 57
          Width = 110
          Height = 28
          DataField = 'unidade_saida'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -15
          Font.Name = 'Segoe UI'
      ...
      object GrpOpcoesProdutos: TGroupBox
        Left = 320
        Top = 96
        Width = 223
        Height = 57
        ...
        ParentFont = False
        TabOrder = 7
        object chkPossuiComplemento: TDBCheckBox
          Left = 15
          Top = 28
          Width = 168
          Height = 17
          Caption = 'Possui Complemento'
          DataField = 'possui_complemento'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -15
          Font.Name = 'Segoe UI'
    ...
    object pnlImagemProdutos: TPanel
      Left = 780
      Top = 97
      Width = 248
      Height = 312
      ...
      BevelOuter = bvNone
      TabOrder = 3
      object btnAdicionarImagem: TSpeedButton
        Left = 8
        Top = 217
        Width = 125
        Height = 83
        ...
        ShowHint = True
        Spacing = 1
        OnClick = btnAdicionarImagemClick
      end
      object btnExcluirImagem: TSpeedButton
        Left = 139
        Top = 217
        Width = 104
        Height = 83
        Cursor = crHandPoint
        Hint = 'Clique para excluir a imagem'
        Align = alCustom
        Anchors = []
      ...
      object DBImagemProduto: TDBImage
        Left = 17
        Top = 10
        Width = 223
        Height = 201
        Align = alCustom
        Anchors = []
        DataField = 'caminho_imagem_produto'
        TabOrder = 0
      end
    end
  end
